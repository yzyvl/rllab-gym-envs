...
if sys.platform.startswith("darwin"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__), "../../vendor/mujoco/libmujoco200.dylib"))
elif sys.platform.startswith("linux"):
    # libfile = osp.abspath(osp.join(osp.dirname(__file__), "../../vendor/mujoco/libmujoco200.so"))
    libfile = osp.abspath("/home/steve/.mujoco/mjpro131/bin/libmujoco131.so")
